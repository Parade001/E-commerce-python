...
# ================= 5大工单状态开关 =================
# 对应界面上的 5 个状态复选框：1 = 勾选，0 = 不勾选
# 0-40 分别代表 新建 已派单 进行中 已完成 已关闭
status_0 = 1
status_10 = 1
status_20 = 1
status_30 = 1
status_40 = 1
# ================= 责任方限定 =================
# 填入字典中的责任方名称（如：采购、工厂(运输部)等）。查全部请填 "全部"
# 采购、工厂(运输部)、研发问题、供应商、经销商、物流、快递、客户、店铺、维修商、外包、平台特性、品类、电商责任（逾期判责工单专用）、非电商责任（逾期判责工单专用）、礼包赔付、电商、有异议待划分责任（逾期判责工单专用）
# ⚠️ 注意：仅支持单选！不支持用逗号填写多个。
responsible_name = 工厂(生产部)
